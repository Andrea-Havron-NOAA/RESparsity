# Bayesian AR Diagnostics: centered_manual
...
- **Optimization:** converged = `yes`, gradient norm = `0.47236761287214`.
...
| Gradient quality | `CHECK` | gradient norm = `0.47236761287214` |
...
- Gradient norm: `0.47236761287214`
- Converged: `yes`
