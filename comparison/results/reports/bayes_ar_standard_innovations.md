# Bayesian AR Diagnostics: standard_innovations
...
- **Latent mode:** converged = `yes`, marginal fixed-effect gradient norm = `0.472367612872141`.
...
| Gradient quality | `CHECK` | marginal fixed-effect gradient norm = `0.472367612872141` |
...
- Marginal fixed-effect gradient norm: `0.472367612872141`
...
- Minimum eigenvalue: `2.81773096192293`
- Maximum eigenvalue: `4.44791144030286`
...
|---:|---:|---:|
| `rank_1` | `4.44791144030286` | `0.314646280832335` |
| `rank_2` | `3.72654942839371` | `0.578263246619339` |
| `rank_3` | `3.14403577244254` | `0.800673062075445` |
| `rank_4` | `2.81773096192293` | `1` |
...
- Count: `4`
- Mean: `0.435620810080604`
- Standard deviation: `0.322004232944995`
...
marginal_fixed_gradient_norm: 0.472367612872141
max_marginal_gradient_parameter: fixed_0
max_marginal_gradient_value:  -0.472367612872141
max_abs_marginal_gradient:    0.472367612872141
...
min_eigenvalue:             2.81773096192293
max_eigenvalue:             4.44791144030286
...
1,4.44791144030286,0.314646280832335
2,3.72654942839371,0.578263246619339
3,3.14403577244254,0.800673062075445
4,2.81773096192293,1
...
min_variance:               0.28669245005868
max_variance:               0.294659155460458
...
1,latent_1,0.292375184512558,0.540717287048008,0.250723191988205,0.284054858340175,0.331559680796725,3.63201341848103,3.55984864490289,2.52174563161699,0.267860467759505
2,latent_2,0.292400612040913,0.540740799312307,0.250744997091413,0.280809155453506,0.327771172410165,3.62576983552804,3.55611481810898,2.51115658064264,0.266735696049164
0,latent_0,0.28669245005868,0.535436690990336,0.245850024233312,0.147746089853997,0.17245487958629,3.59709748319499,3.5599941036569,2.21057959815531,0.23480833187835
3,latent_3,0.294659155460458,0.54282516104217,0.25268178668707,0.144113059004676,0.168214267206821,3.49554242705721,3.46027003639326,2.17091835363279,0.230595504312981
...
0,2,latent_0,latent_2,-0.00788847963450344,0.00788847963450344
1,3,latent_1,latent_3,-0.00769481565317715,0.00769481565317715
0,3,latent_0,latent_3,-0.000443244343194951,0.000443244343194951
...
count:                      4
mean:                       0.435620810080604
sd:                         0.322004232944995
min_value:                  -0.0205362485009595
max_value:                  0.842265440854571
min_index:                  0
max_index:                  2
l2_norm:                    1.08342460044024
```
